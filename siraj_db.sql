...
--
-- Host: localhost:3306
-- Generation Time: Apr 08, 2026 at 08:43 AM
...
(17, 'Home', 200, 'Riyadh', 'Warning', 18, 12),
(18, 'School', 400, 'Jeddah', 'Warning', 19, 12),
...
(1, 'sarah mohhamd', 'sarah@email.com', '$2y$10$l1rTIbGfE5EvTOMG98CQqO6Xlm3e9LvL2QMkx585YeKowdB.D9Bte', 'panel_owner', 1, '2026-02-10 00:00:00', '69d6037bee853.png'),
(2, 'Reem', 'reem@email.com', 'hashed_pw', 'panel_owner', 1, '2026-01-18 00:00:00', 'default.png'),
(3, 'Aljory', 'admin@email.com', '$2y$10$l1rTIbGfE5EvTOMG98CQqO6Xlm3e9LvL2QMkx585YeKowdB.D9Bte', 'admin', 1, '2025-12-01 00:00:00', '69d605651b055.png'),
...
--
ALTER TABLE `alert`
  MODIFY `alertID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `enviromentaldata`
--
ALTER TABLE `enviromentaldata`
  MODIFY `enviromentalDataID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT for table `panel`
--
ALTER TABLE `panel`
  MODIFY `panelID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `reading`
--
ALTER TABLE `reading`
  MODIFY `readingID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT for table `sensor`
--
ALTER TABLE `sensor`
  MODIFY `sensorID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT for table `storage_unit`
--
ALTER TABLE `storage_unit`
  MODIFY `storageID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
